...
public class HistoryHandler {
	...
	File parkingHistoryFile = new File("/src/media/Parking_History.txt"); //file used to display parking data
...
//method to write the data in a readable format in a text file to be displayed in the GUI
	public void save(String parkingHistoryFile) throws FileNotFoundException{
		try {
			BufferedWriter writer = new BufferedWriter(new FileWriter(parkingHistoryFile));
			for (double i = 0.0; i<histL; i++){
				
				//this will write to the parking history file that can be accessed in display UI
			}
